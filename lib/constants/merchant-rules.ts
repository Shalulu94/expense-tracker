...
export const DEFAULT_MERCHANT_RULES: MerchantRule[] = [
  ...
  // ── Health & Wellbeing ─────────────────────────────────────────────────────
  rule('chemist warehouse',    CAT_IDS.HEALTH_PHARMACY),
  rule('lloyds pharmacy',      CAT_IDS.HEALTH_PHARMACY),
  rule('pharmacy',             CAT_IDS.HEALTH_PHARMACY),
  rule('pline pharm',          CAT_IDS.HEALTH_PHARMACY),
  rule('pline ph ',            CAT_IDS.HEALTH_PHARMACY),
  rule('pharmacy 4 less',      CAT_IDS.HEALTH_PHARMACY),
  rule('bayswater nth pharm',  CAT_IDS.HEALTH_PHARMACY),
  rule('cwh forest hill',      CAT_IDS.HEALTH_PHARMACY),
  rule('boots',                CAT_IDS.HEALTH_PHARMACY),
